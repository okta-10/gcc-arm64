...
enum opt_code
{
  ...
  OPT_momit_leaf_frame_pointer = 1782,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1783,               /* -moutline-atomics */
  OPT_moverride_ = 1784,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1785,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1786,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1787, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1788,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1789,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1790,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1791,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1792,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1793,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1794,             /* -mtrack-speculation */
  OPT_mtune_ = 1795,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1796,             /* -mverbose-cost-dump */
  OPT_n = 1797,                              /* -n */
